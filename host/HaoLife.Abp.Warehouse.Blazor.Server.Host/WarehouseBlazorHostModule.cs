...
using HaoLife.Abp.Warehouse.Blazor.Server.Host.Components;
using HaoLife.Abp.Warehouse.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(WarehouseBlazorServerModule)
)]
public class WarehouseBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(WarehouseResource),
                typeof(WarehouseDomainModule).Assembly,
                typeof(WarehouseDomainSharedModule).Assembly,
                typeof(WarehouseApplicationModule).Assembly,
                typeof(WarehouseApplicationContractsModule).Assembly,
                typeof(WarehouseBlazorHostModule).Assembly
            );
        });
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles(new BundleFile("/HaoLife.Abp.Warehouse.Blazor.Server.Host.styles.css", true));
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<WarehouseBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(WarehouseBlazorHostModule).Assembly;
        });
